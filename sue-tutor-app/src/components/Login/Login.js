            ...
            >
               ...
               <Box 
                ...
                >
                   ...
                   <TextField label="Username" size="small" sx={{color: backgroundColor}}></TextField>
                   <TextField label="password" size="small" variant="outlined" type="password" sx={{color: backgroundColor}}></TextField>
                   <Button variant="outlined" sx={{color: backgroundColor}}>Login</Button>
                   <Divider>
